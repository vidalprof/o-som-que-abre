...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="cena"><i class="foco"></i>' + '<div class="it" style="animation-delay:0.00s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/so_bola.png?v=' + V + '" alt="">' + '<span class="rt">B</span>' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/so_boneca.png?v=' + V + '" alt="">' + '<span class="rt">B</span>' + '</div>' + '<div class="it" style="animation-delay:0.70s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/so_bota.png?v=' + V + '" alt="">' + '<span class="rt">B</span>' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/so_banana.png?v=' + V + '" alt="">' + '<span class="rt">B</span>' + '</div>' + '</div><div class="prat"></div>' +
...
var TRIO = {"macaco": ["mala", "navio", "pato"], "sapo": ["sapato", "uva", "macaco"], "faca": ["foca", "macaco", "gato"], "vaca": ["vela", "ovo", "elefante"], "lata": ["lupa", "elefante", "abelha"], "pato": ["panela", "faca", "gato"], "bola": ["bolo", "lata", "zebra"], "tomate": ["tesoura", "abelha", "bola"], "batata": ["boca", "sino", "uva"], "panela": ["pipoca", "mala", "dado"], "tesoura": ["tijolo", "mala", "uva"], "cachorro": ["caracol", "sino", "vela"]};
var LETRAOPS = {"abelha": ["A", "E", "G"], "bola": ["B", "O", "Z"], "casa": ["C", "R", "X"], "dado": ["D", "G", "I"], "faca": ["A", "F", "S"], "gato": ["A", "B", "G"], "igreja": ["B", "I", "T"], "lata": ["C", "L", "T"], "macaco": ["L", "M", "N"], "navio": ["C", "N", "V"], "ovo": ["E", "O", "U"], "pato": ["M", "O", "P"], "sapo": ["G", "S", "V"], "tomate": ["N", "R", "T"], "uva": ["B", "E", "U"], "vaca": ["L", "V", "X"], "xicara": ["O", "T", "X"], "zebra": ["D", "F", "Z"], "batata": ["B", "D", "P"], "panela": ["N", "P", "V"], "caracol": ["C", "L", "S"], "galinha": ["D", "G", "T"], "morcego": ["M", "N", "R"], "bolo": ["B", "D", "P"], "tesoura": ["F", "T", "V"], "laranja": ["L", "N", "R"]};
